...
def app(diabetes_df):
    ...
    bp = st.slider("Blood_Pressure", int(diabetes_df["Blood_Pressure"].min()), int(diabetes_df["Blood_Pressure"].max()))
    ...
    pedigree = st.slider("Pedigree_Function", float(diabetes_df["Pedigree_Function"].min()), float(diabetes_df["Pedigree_Function"].max()))
